...
\section{pavyzdžiai}
	\subsection{USB jungtis}
		...
		\item Apibendrinimas – pusė, kuria kišamas USB kištukas kiekviename įrenginyje gali skirtis.
	...
	\subsection{Mikrobangų krosnelė}
		...
		\item Pakeičiamumas – bet kuriuo įrenginio veikimo momentu galima pakeisti temperatūrą ir nustatytą naują laiką.
	...
	\subsection{Mobili 15min.lt versija}	
		...
		\begin{figure}[!htpb]
		\centering
		\includegraphics[width=0.4\textwidth]{images/15min.png}
		\caption{15min.lt mobili versija}
		\label{overflow}
		\end{figure}
		\newpage
